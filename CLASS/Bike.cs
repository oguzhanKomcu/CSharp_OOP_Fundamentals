...
namespace CLASS
{
    class Bike
    {
        //If we want our members in the class to be accessed from outside, we should make it public.
        //If we don't want it to be accessed and we put private at the beginning, it will be inaccessible. 
        //If we don't put anything at the beginning of another field, it will already be private by default.
